    ...
    <SectionContainer id="lineup" bgColor="purple">
      ...
      <div className="max-w-[800px] space-y-4">
        <p>
          ...
          různých žánrů, a&nbsp;to od rocku přespop až po rap.
        </p>
        <p>
        ...
        <p>
          Mimo jiné se můžete zapojit i&nbsp;do doprovodných programů, ve kterých můžete vyhráthodnotné ceny nebo se
          prostě jen pořádně zasmát, navštívit Chill-out zónu, kde si pořádně odpočinete, nebo si zajít na dobré jídlo
