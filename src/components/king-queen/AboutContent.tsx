  ...
  return (
    <div className="space-y-8 max-w-2xl">
      ...
      <div>
        ...
        <p>
          Soutěžní dvojice musí být složena z muže a ženy, kteří studují na jakékoliv fakultě UTB (klidně může být jeden
          z FT a druhý z FHS).
        </p>
      </div>
      <div>
        <h2 className="text-h2">Kde a kdy se akce koná?</h2>
        <p>Akce se uskuteční 3. 5. 2024 v rámci Majálesu UTB v areálu festivalu.</p>
      </div>
    </div>
  );
};
