...
export const HeadlineBubble = ({ fillColor = '#EF5A23', rotationValue = 0, children }: Props) => {
  return (
    <div className="relative max-w-max" style={{ transform: `rotate(${rotationValue}deg)` }}>
      <svg width="100%" height="auto" viewBox="0 0 337 189" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <h2 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-h2 text-beige">{children}</h2>
    </div>
  );
};
