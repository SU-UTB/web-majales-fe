...
export const MajalesHeadlineDateLanding = () => {
  return (
    <SectionContainer
      id="majales-headline"
      className="bg-[url('/assets/img/majales-heading-mob-left.webp'),_url('/assets/img/majales-heading-mob-right.webp')] bg-[position:left,_right] lg:bg-[url('/assets/img/majales-heading-left.webp'),_url('/assets/img/majales-heading-right.webp')]"
    >
